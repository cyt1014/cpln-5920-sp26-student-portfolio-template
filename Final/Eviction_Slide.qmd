...
```{=html}
<style>
.reveal .compact-model-table table {
  font-size: 0.54em;
  line-height: 1.15;
}
.reveal .compact-model-table th,
.reveal .compact-model-table td {
...
::: compact-model-table
| Criterion | Best model | Scale | MAE | RMSE | Correlation |
|------------|------------|------------|-----------:|-----------:|-----------:|
| Lowest error | Rolling monthly baseline | Monthly | 1.657 | 2.441 | 0.678 |
| Strongest ranking | Quarterly temporal baseline | Quarterly | 3.718 | 5.422 | 0.779 |
| Richer covariates | Monthly NB covariates | Monthly | 2.137 | 4.265 | 0.594 |
:::
...
-   Monthly forecasts provide more timely identification of eviction risk. 
