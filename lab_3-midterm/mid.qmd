...
```{r primary data}
phl_props <- st_read("C:/Users/cheny/Desktop/PPA Mid Data/opa_properties_public.geojson", quiet = TRUE) %>%
  st_transform(2272) %>%
  mutate(
...
```{r Spatial}
septa_stops <- st_read("C:/Users/cheny/Desktop/PPA Mid Data/Transit_Stops_(Spring_2025).geojson", quiet = TRUE) %>%
  st_transform(2272)

phl_trees <- st_read("C:/Users/cheny/Desktop/PPA Mid Data/ppr_tree_inventory_2025.geojson", quiet = TRUE) %>%
  st_transform(2272)

schools <- st_read("C:/Users/cheny/Desktop/PPA Mid Data/Schools.geojson", quiet = TRUE) %>%
  st_transform(2272)
...
phl_nhoods <- st_read(
  "C:/Users/cheny/Desktop/PPA Mid Data/philadelphia-neighborhoods.geojson",
  quiet = TRUE
) %>%
  st_transform(2272) %>%
